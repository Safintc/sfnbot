...
<blockquote>©️ Maintained by <a href="https://t.me/safinct">@safinct</a></blockquote>"""
...
"""
    ABOUT_TXT = """<b>
<blockquote>🤖 Nᴀᴍᴇ: ꜱғɴ ʙᴏᴛ™ </blockquote>

👨‍💻 Cʀᴇᴀᴛᴏʀ: <a href="https://t.me/safinct">Safin</a>  
💬 Lᴀɴɢᴜᴀɢᴇ: Pʏᴛʜᴏɴ 3  
🗄️ Dᴀᴛᴀʙᴀsᴇ: Mᴏɴɢᴏ DB  
🌐 Sᴇʀᴠᴇʀ: KᴏYᴇʙ
</b>"""
    SOURCE_TXT = """<b>📢 NOTE:</b>
<blockquote>ꜱғɴ ʙᴏᴛ™ is an open source project.</blockquote>

🔗 <b>Source Code:</b> <a href="https://github.com/Safintc">Click Here 😂</a>

<b>👨‍💻 DEVS:</b>  
<blockquote><a href="https://t.me/moviestoreupdates"> ꜱᴀғɪɴ ✅</a></blockquote>
"""
...
➕ Added By: {}
"""
    RESULT_TXT = """<b> 📁 𝖧𝖾𝗋𝖾 𝖨𝗌 𝖶𝗁𝖺𝗍 𝖨 𝖥𝗈𝗎𝗇𝖽 𝖨𝗇 𝖬𝗒 𝖣𝖺𝗍𝖺𝖻𝖺𝗌𝖾 𝖥𝗈𝗋 𝖸𝗈𝗎𝗋 𝖰𝗎𝖾𝗋𝗒 👇</b>
...
🔗 [⚡ Jᴏɪɴ ⚡](https://t.me/moviestoreupdates)</b>"""
    
    RESTART_GC_TXT = """
<b>🔄 𝖡𝗈𝗍 𝖱𝖾𝗌𝗍𝖺𝗋𝗍𝖾𝖽!</b>
ꜱғɴ ʙᴏᴛ
<a href="https://t.me/safinct">@safinct</a>
...
"""
    ...
    CHK_MOV_ALRT = "♻️ ᴄʜᴇᴄᴋɪɴɢ ꜰɪʟᴇ ᴏɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ... ♻️"

    OLD_MES = " 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐨𝐧𝐞 𝐨𝐟 𝐦𝐲 𝐨𝐥𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 🤔. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 𝐭𝐡𝐞 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐚𝐠𝐚𝐢𝐧."

    MOV_NT_FND = """<b> ᴛʜɪs ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ʏᴇᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ɴᴏᴛ ғᴏᴜɴᴅ ᴏɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ. </b>
<blockquote>Report To ADMIN - <a href="https://t.me/sfn_moviestore">@sfn_moviestoreupdate</a></blockquote>
"""
